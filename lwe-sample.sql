...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 05, 2017 at 11:01 PM
...
(2, 'Albert Ling', '0168749963', 'albert@email.com', 'Reset Password', NULL, 'Hi, can you reset my password? C I forgot my password', '2017-10-15 03:15:26', 'unread'),
...
(4, 10, 'Desmond Kuok', '0192856375', 2, '2.00', '60.00', 'Proceed', '2017-11-05 21:22:03', NULL),
(17, 10, 'Desmond Kuok', '0192856375', 2, '1.00', '30.00', 'Delivered', '2017-11-05 21:18:01', 'EM8505MY'),
...
INSERT INTO `users` (`user_id`, `fname`, `lname`, `contact`, `email`, `password`, `type`, `image`) VALUES
(1, 'Albert', 'Ling', '0168749963', 'albert@email.com', '$2y$10$4Qss.2kEXKmEciQ0HZ0N1OOaYqXrbymg38gtdjiLlG5e4sFkGvarS', 'customer', '../resources/avatar1.jpg'),
(2, 'Bobby ', 'Tang', '0139985562', 'bobby@email.com', '$2y$10$2453Uie/j6yywD02UOFlU.9cH0acQPlkXZsvL3XSbEEQjUTy9/sKS', 'customer', '../resources/avatar1.jpg'),
(3, 'Clement', 'Chuo', '0124789652', 'clement@email.com', '$2y$10$xzv/iSSjAuxLhLbR4rgTdeYHuy01BPZjzHJ.9R9hPix5Dpw0nGr2y', 'admin', '../resources/avatar1.jpg'),
(5, 'Eileeen', 'Kho', '01116589986', 'eileen@email.com', '$2y$10$NKkhLKxM46HnB/4EeRpjw.gWuvwiz/mfcsds7Q4zEMZxgq2N1vJ96', 'admin', '../resources/avatar1.jpg'),
(6, 'Fabian', 'Tang', '0178589321', 'fabian@email.com', '$2y$10$E3CcjibNLt/D79t7soUKve1j1JoZDUmMuVjgP1Piigugao6GG9F3C', 'staff', '../resources/avatar1.jpg'),
(7, 'Gordon', 'Yii', '0146587123', 'gordon@email.com', '$2y$10$uOpSbmMFqUesTmvPklp56OHMcAb..qshAlOz31xUN0LeXuYMYddYK', 'customer', '../resources/avatar1.jpg'),
(8, 'Samuel', 'Hii', '0105843214', 'samuel@email.com', '$2y$10$nuOJ73sWDmZsWvdrR.bLkOyNaXCXCj2fz1BWTsE3PYJaxA7k2KRo.', 'admin', '../resources/avatar1.jpg'),
(10, 'Desmond', 'Kuok', '0192856375', 'desmond@email.com', '$2y$10$pLraOonvL8szr4M/YISX/uX1xZZbbM9Tabe4CeX0iZVhq.9vXjVoO', 'customer', '../resources/avatar1.jpg');
...
(3, 'L-KLK', 'Tower 3, Level 3A, Unit 7 (03-03A-07)\nUOA Business Park\nNo.1, Jalan Pengaturcara U1/51A\nSeksyen U1, 40150 Shah Alam\nSelangor Darul Ehsan. Malaysia', 'MY', 'MALAYSIA', 'OGISTICS WORLDWIDE EXPRESS (MY)', '11'),
(4, 'L-TP', 'No.323, Sec. 2, Nanzhu Rd., Luzhu Dist., Taoyuan City 338, Taiwan', 'TW', 'TAIWAN', 'LOGISTICS WORLDWIDE EXPRESS (TW)', '111'),
(5, 'L-SGP', '26 Kallang Avenue #06-00\nSingapore 339417', 'SG', 'SINGAPORE', 'LOGISTICS WORLDWIDE EXPRESS (SINGAPORE)', '111'),
(6, 'L-KR', 'ROOM 602, Bumhwa Building, 34 Namdaemun-Ro 1-Gil Jung-Gu', 'KR', 'KOREA', 'LOGISTICS WORLDWIDE EXPRESS (KOREA)', 'exd');
