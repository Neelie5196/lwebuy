...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 01, 2017 at 03:07 AM
...
CREATE TABLE `shipping` (
  ...
  `SummaryList` varchar(1000) NOT NULL,
  `HawbNo` varchar(12) NOT NULL,
  ...
  `DeliveryDate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `RecipientName` varchar(20) NOT NULL,
  `SignedName` varchar(20) NOT NULL,
  `OriginStationCode` varchar(20) NOT NULL,
  `OriginStationDescription` varchar(100) NOT NULL,
  `OriginCountryCode` varchar(10) NOT NULL,
  `OriginCountryDescription` varchar(20) NOT NULL,
  `DestinationStationCode` varchar(20) NOT NULL,
  `DestinationStationDescription` varchar(20) NOT NULL,
  `DestinationCountryCode` varchar(10) NOT NULL,
  `DestinationCountryDescription` varchar(20) NOT NULL,
  `EventCode` varchar(20) NOT NULL,
  `EventDescription` varchar(100) NOT NULL,
  `ReasonCode` varchar(20) NOT NULL,
  `ReasonDescription` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `shipping` (`s_id`, `user_id`, `ErrorCode`, `ErrorMessage`, `SummaryList`, `HawbNo`, `XR1`, `XR2`, `ShipmentDate`, `DeliveryDate`, `RecipientName`, `SignedName`, `OriginStationCode`, `OriginStationDescription`, `OriginCountryCode`, `OriginCountryDescription`, `DestinationStationCode`, `DestinationStationDescription`, `DestinationCountryCode`, `DestinationCountryDescription`, `EventCode`, `EventDescription`, `ReasonCode`, `ReasonDescription`) VALUES
(0, 10, 0, '', '', '', '', '', '2017-10-01 00:00:00', '2017-10-02 00:00:00', 'Clement', 'Clement', 'KUL', 'Kuala Lumpur', 'MY', 'Malaysia', 'KCH', 'Kuching', 'MY', 'Malaysia', '1', 'pending', '', '');
