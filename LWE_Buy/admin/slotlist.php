                                    ...
                                    <table class="table thead-bordered table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="slotitem.php?slotcode=<?php echo $slot['slot_code']; ?>&slotnum=<?php echo $slot['slot_num']; ?>&user_id=<?php echo $slot['user_id']; ?>" class="btn btn-xs btn-info">View</a></td>
                                            </tr>
                                        </tbody>
                                        <?php endforeach; ?>
                                    </table>
