                                    ...
                                    while($row = mysqli_fetch_array($result1))
                                    {
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width="20%"><a href="usersview.php?users=<?php echo $row['user_id']; ?>" class="btn btn-xs btn-default">View Detail</a> <a href="editusers.php?users=<?php echo $row['user_id']; ?>" class="btn btn-xs btn-default">Edit</a> <a href="delete2.php?user_id=<?php echo $row['user_id']; ?>" class="btn btn-xs btn-danger">Delete</a></td>
                                            </tr>
                                        </tbody>
                                        <?php
                                    }
